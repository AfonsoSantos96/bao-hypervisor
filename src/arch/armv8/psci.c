...
//    cpu()->arch.psci_off_state.ttbr0_el2 = 0;//MRS(TTBR0_EL2);
    cpu()->arch.psci_off_state.hmair0 = sysreg_hmair0_read();
    cpu()->arch.psci_off_state.hmair1 = sysreg_hmair1_read();
    cpu()->arch.psci_off_state.cptr_el2 = sysreg_hcptr_read();
    cpu()->arch.psci_off_state.hcr  = sysreg_hcr_read();
    cpu()->arch.psci_off_state.hcr2 = sysreg_hcr2_read();
    cpu()->arch.psci_off_state.vmpidr = sysreg_vmpidr_read();
