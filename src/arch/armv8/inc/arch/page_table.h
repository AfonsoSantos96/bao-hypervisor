...
#define PTE_ADDR_MSK ADDR_MSK(47, 12)                // REVIEW and change MSB
...
#define PTE_APTable_MSK (0x3L << PTE_APTable_OFF)
#define PTE_APTable_ALL (0x0L << PTE_APTable_OFF)
#define PTE_APTable_NOEL0 (0x1L << PTE_APTable_OFF)
#define PTE_APTable_RO (0x2L << PTE_APTable_OFF)
#define PTE_APTable_RO_NOEL0 (0x3L << PTE_APTable_OFF)
#define PTE_XNTable (1L << 60)
#define PTE_PXNTable (1L << 59)
...
#define PTE_Con (1L << 52)
#define PTE_DBM (1L << 51)
#define PTE_nG (1L << 11)
#define PTE_AF (1L << 10)
#define PTE_SH_OFF (8)
#define PTE_SH_MSK (0x3L << PTE_SH_OFF)
#define PTE_SH_NS (0x0L << PTE_SH_OFF)
#define PTE_SH_OS (0x2L << PTE_SH_OFF)
#define PTE_SH_IS (0x3L << PTE_SH_OFF)
#define PTE_AP_OFF (6)
#define PTE_AP_MSK (0x3L << PTE_AP_OFF)
#define PTE_AP_RW_PRIV (0x0L << PTE_AP_OFF)
#define PTE_AP_RO_PRIV (0x2L << PTE_AP_OFF)
#define PTE_AP_RW (0x1L << PTE_AP_OFF)
#define PTE_AP_RO (0x3L << PTE_AP_OFF)
#define PTE_NS (1 << 5)
#define PTE_ATTR_OFF (2)
#define PTE_ATTR_MSK (0x7L << PTE_ATTR_OFF)
...
#define PTE_RSW_EMPT (0x0UL << PTE_RSW_OFF)
#define PTE_RSW_OPEN (0x1UL << PTE_RSW_OFF)
#define PTE_RSW_FULL (0x2UL << PTE_RSW_OFF)
#define PTE_RSW_RSRV (0x3UL << PTE_RSW_OFF)
